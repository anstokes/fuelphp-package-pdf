...
class Pdf_Interface
{
    ...
    {
        return $this->oPdf->GetArrStringWidth([$char], $fontfamily, $fontstyle, $fontsize);
    }
    ...
    {
        $currentFont = $this->oPdf->CurrentFont();
        return TCPDF_FONTS::UTF8StringToArray($str, $this->oPdf->isunicode(), $currentFont);
    }
