...
/**
 * Pdf Advanced Multicell class
 * This class extends Pdf_Multicell and it's kept for backward compatibility.
 *
...
require_once(dirname(__FILE__) . '/Pdf/Multicell.php');

class PdfMulticell extends Pdf_Multicell
{
}
